...
class TestDatabase(unittest.TestCase):
    ...
    def test_00_addEmployee(self):
        ...
        self.assertEqual(6, len(result), "Result should have been a length of 6")
    ...
    def test_03_getAllEmployees(self):
        ...
        data = dict(firstName="joe", lastName="alice", birthYear=2001, phoneNumber=5701112223)
        jdata = json.dumps(data)
        hdr = {'content-type': 'application/json'}
        post_rest_call(self, 'http://localhost:5000/createEmployee', jdata, hdr)
    ...
    def test_04_getEmployee(self):
        ...
        data = dict(firstName="chris2", lastName="banas2", birthYear=2001, phoneNumber=5701112223)
        jdata = json.dumps(data)
        hdr = {'content-type': 'application/json'}
        post_rest_call(self, 'http://localhost:5000/createEmployee', jdata, hdr)
        code2 = post_rest_call(self, 'http://localhost:5000/hashEmployee', jdata, hdr)
